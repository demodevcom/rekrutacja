...
// date: 2012/05/31 16:50:45
  ...
  'cache_dir' => '/usr/local/apache/www/htdocs/wste.edu.fr.pl/wste/cmswste/rekrutacja/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/usr/local/apache/www/htdocs/wste.edu.fr.pl/wste/cmswste/rekrutacja/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/usr/local/apache/www/htdocs/wste.edu.fr.pl/wste/cmswste/rekrutacja/cache/frontend/prod/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/usr/local/apache/www/htdocs/wste.edu.fr.pl/wste/cmswste/rekrutacja/apps/frontend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/usr/local/apache/www/htdocs/wste.edu.fr.pl/wste/cmswste/rekrutacja/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/usr/local/apache/www/htdocs/wste.edu.fr.pl/wste/cmswste/rekrutacja/apps/frontend/template',
)));
