 ...
 */
class KandydatEditForm extends BaseKandydatForm {
	...
	public function configure() {
		...
		$this->validatorSchema['zameldowanie_ulica'] = new sfValidatorAnd(array (
			...
			new sfValidatorRegex(array (
				'pattern' => '/^[a-zA-Z0-9- \wł\wń\wś\wć\wż\wź\wó\wą\wę\wŁ\Ś\wŻ\wŹ\wĆ\wÓ]+$/',
				'required' => false,
				'trim' => true
			), array (
		...
		$this->validatorSchema['zameldowanie_miasto'] = new sfValidatorAnd(array (
			...
			new sfValidatorRegex(array (
				'pattern' => '/^[a-zA-Z0-9- \wł\wń\wś\wć\wż\wź\wó\wą\wę\wŁ\wŚ\wŻ\wŃ\wŹ\wĆ\wÓ]+$/',
				'required' => false,
				'trim' => true
			), array (
				'invalid' => 'Pole zawiera niedozwolone znaki'
		...
		$this->validatorSchema['korespondencja_ulica'] = new sfValidatorAnd(array (
			...
			new sfValidatorRegex(array (
				'pattern' => '/^[a-zA-Z0-9- \wł\wń\wś\wć\wż\wź\wó\wą\wę\wŁ\wŚ\wŻ\wŹ\wĆ\wÓ]+$/',
				'required' => false,
				'trim' => true
			), array (
				'invalid' => 'Pole zawiera niedozwolone znaki'
